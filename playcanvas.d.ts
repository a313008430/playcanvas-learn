...
declare var loadGltf: any;
declare var loadGlb: any;
...
declare namespace pc {
    ...
    * {number} view: Type of view. Can be pc.VIEW_CENTER, pc.VIEW_LEFT or pc.VIEW_RIGHT. Left and right are only used in stereo rendering.
	...
	function drawQuadWithShader(
		device: pc.GraphicsDevice,
		target: pc.RenderTarget | undefined,
		shader: pc.Shader,
		rect?: pc.Vec4,
		scissorRect?: pc.Vec4,
		useBlend?: boolean
    ...
    * {@link pc.TYPE_FLOAT32}
	...
	class Controller {
		 ...
		 */
		registerAxis(options?: { pad?: any }): void;
		/**
    ...
    * {@link pc.PRIMITIVE_TRIFAN}
	...
	class ScriptType extends pc.EventHandler {
		constructor(args: { app: pc.Application; entity: pc.Entity });
		/**
