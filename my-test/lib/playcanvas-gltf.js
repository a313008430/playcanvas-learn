Object.assign(
  ...
  (function () {
      ...
      data.channels.forEach(function (channel) {
        ...
        if (path === "weights") {
          for (i = 0; i < numCurves; i++) {
            ...
            if (sampler.interpolation === "CUBIC") curve.type = AnimationCurveType.CUBIC;
            else if (sampler.interpolation === "STEP") curve.type = AnimationCurveType.STEP;
        ...
        gltf.textures.forEach(function (texture, idx) {
          if (texture.hasOwnProperty("source")) {
            if (texture.source === imageIndex) {
              ...
              if (
                (!isPowerOf2(image.width) || !isPowerOf2(image.width)) &&
        ...
        if (primitive.hasOwnProperty("extensions")) {
          ...
          if (extensions.hasOwnProperty("KHR_draco_mesh_compression")) {
            ...
            if (geometryType == decoderModule.TRIANGULAR_MESH) {
              ...
              indices =
                numPoints > 65535 ? new Uint32Array(numFaces * 3) : new Uint16Array(numFaces * 3);
        ...
        if (colors !== null) {
          ...
          for (i = 0; i < numVertices; i++) {
            ...
            vertexDataU8[dstIndex + 3] =
              accessor.type === "VEC4" ? Math.round(pc.math.clamp(a, 0, 1) * 255) : 255;
          }
        }
    ...
    function loadGltf(gltf, device, done, options) {
      ...
      var processUri =
        options && options.hasOwnProperty("processUri") ? options.processUri : undefined;
